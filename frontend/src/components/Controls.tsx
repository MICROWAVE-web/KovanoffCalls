...
/** Material flip_camera_android — camera body with circular arrows on top. */
function FlipCameraIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="currentColor" aria-hidden>
      <path d="M20 5h-3.17L15 3H9L7.83 5H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm-5 14H9V7h6v12z" />
      <path d="M9 12c0 1.66 1.34 3 3 3 .46 0 .89-.11 1.28-.3l1.43 1.43A4.98 4.98 0 0 1 12 17c-2.76 0-5-2.24-5-5H4l2.5-2.5L9 7v5zm6-5h5l-2.5-2.5L15 7v5c0 2.76-2.24 5-5 5a4.98 4.98 0 0 1-2.71-.8l1.43-1.43c.39.19.82.3 1.28.3 1.66 0 3-1.34 3-3V7z" />
    </svg>
  );
}
