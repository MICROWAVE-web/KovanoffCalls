...
export function Controls() {
  ...
  const mediaMode = useAppStore((s) => s.activeCall?.mediaMode ?? "video");
  const isVideoCall = mediaMode === "video";
...
function FlipCameraIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="currentColor" aria-hidden>
      <path d="M16 7h-1.26c.67-1.01 1.82-1.7 3.13-1.7 2.07 0 3.75 1.68 3.75 3.75 0 .55-.12 1.07-.33 1.55l1.46 1.46A5.97 5.97 0 0 0 22 9.05C22 5.5 19.05 2.55 15.5 2.55c-2.07 0-3.9 1.03-5 2.6V4H8v4h4V6.6c.75-1.17 2.06-1.95 3.5-1.95 1.38 0 2.5 1.12 2.5 2.5 0 .97-.56 1.8-1.37 2.22L16 7ZM7.5 21.45c2.07 0 3.9-1.03 5-2.6V20h1v-4H9.5v1.4c-.75 1.17-2.06 1.95-3.5 1.95-1.38 0-2.5-1.12-2.5-2.5 0-.97.56-1.8 1.37-2.22L8 17h1.26c-.67 1.01-1.82 1.7-3.13 1.7-2.07 0-3.75-1.68-3.75-3.75 0-.55.12-1.07.33-1.55L1.25 10.44A5.97 5.97 0 0 0 2 14.95c0 3.55 2.95 6.5 6.5 6.5Z" />
    </svg>
  );
}
